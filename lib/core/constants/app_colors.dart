...
abstract final class AppColors {
  ...
  static const Color primaryLight = Color(0xFF83D5C6);       // inverse-primary / primary-fixed-dim
  ...
  static const Color primaryContainer = Color(0xFF95E8D9);   // on-primary-container
  ...
  static const Color secondaryDark = Color(0xFF004395);      // on-secondary-fixed-variant
  static const Color secondaryContainer = Color(0xFFD8E2FF); // secondary-fixed
  static const Color secondaryOnContainer = Color(0xFF002C66); // on-secondary-container
  ...
  static const Color tertiaryContainer = Color(0xFF9C4426);  // tertiary-container
  static const Color tertiaryOnContainer = Color(0xFFFFCEBF); // on-tertiary-container
  ...
  // ────────────────────────────────────────────
  static const Color lightBackground = Color(0xFFF7FAF8);        // surface / background
  static const Color lightSurface = Color(0xFFFFFFFF);           // surface-container-lowest
  static const Color lightSurfaceContainerLow = Color(0xFFF1F4F2); // surface-container-low
  static const Color lightSurfaceContainer = Color(0xFFEBEFEC);  // surface-container
  static const Color lightSurfaceContainerHigh = Color(0xFFE5E9E7); // surface-container-high
  static const Color lightSurfaceVariant = Color(0xFFE0E3E1);    // surface-variant / surface-container-highest
  ...
  static const Color lightTextOnSurfaceVariant = Color(0xFF3E4946); // on-surface-variant
  ...
  // ────────────────────────────────────────────
  static const Color darkBackground = Color(0xFF181C1B);         // on-background → dark bg
  ...
  static const Color shimmerHighlightLight = Color(0xFFF1F4F2);  // surface-container-low
